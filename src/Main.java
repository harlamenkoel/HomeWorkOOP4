...
public class Main {
    public static void main(String[] args) {
        Car nissan = new Car("Nissan", "GT-R", 3.8);
        Car chevrolet = new Car("Chevrolet", "Camaro", 6.2);
        Car ford = new Car("Ford", "Mustang", 4.2);
        Car dodge = new Car("Dodge", "Charger", 3.6);

        Truck international = new Truck("International", "9400i", 15.0);
        Truck freightliner = new Truck("Freightliner", "Classic XL", 14.0);
        Truck volvo = new Truck("Volvo", "VT 880", 16.0);
        Truck kamaz = new Truck("КамАЗ", "4326-9", 16.2);

        Bus mercedes = new Bus("Mercedes-Benz", "Connect", 10.7);
        Bus liaz = new Bus("ЛиАЗ", "6274", 11);
        Bus olimp = new Bus("Олимп", "4252", 6.7);
        Bus hyundai = new Bus("Hyundai", "Богдан", 3.9);
